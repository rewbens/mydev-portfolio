...
function ProjectCard(props) {
    ...
    return (
        <div className={"flex flex-col " + (index % 2 === 0 ? 'md:flexrow' : 'md:flex-row-reverse')}>
            ...
            <div className="flex flex-col flex-1 justify-center items-center">
                ...
                <p className="text-xs sm:text-sm text-justify px-4 pb-4 sm:p-6 sm:pb-6">{project.description}</p>
